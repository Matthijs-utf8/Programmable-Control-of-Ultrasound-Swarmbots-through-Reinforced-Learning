...
UPDATE_RATE_ENV = 1  # Update Vpp and frequency every UPDATE_RATE_ENV steps
SAVE_RATE_METADATA = 50
PIEZO_RESONANCES = {0: 2350, 1: 1400, 2: 2000, 3: 1900} # kHz
...
EXPERIMENT_RUN_NAME = 'Circles_max_1' # Use a descriptive name here so you know what you did during the experiment
