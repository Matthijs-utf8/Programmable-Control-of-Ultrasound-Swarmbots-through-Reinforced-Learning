...
SAVE_DIR = "C:\\Users\\ARSL\\PycharmProjects\\Project_Matt\\experiments_straight_channel_23_11_2021\\"  # Location for images
IMG_SIZE = 300  # Size of environment (IMG_SIZE, IMG_SIZE)
OFFSET_BOUNDS = 20  # Minimum Euclidean distance for reaching checkpoint
TARGET_POINTS = [(90, 275), (25, 210)]  # Checkpoints
UPDATE_ENV_EVERY = 25  # Update Vpp and frequency every UPDATE_ENV_EVERY steps
...
# Data settings
import pandas
metadata_filename = "experiments_straight_channel_23_11_2021_2.0.csv"
try:
